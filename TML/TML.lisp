...
(defclass TMLElement ()
    ...
    (write (view redraw)
        ...
        (setl height-offset (height view))
        (doit child :children this
            ...
            (if (|| redraw (updated child))
                (write child (sub-view view (minus height-offset (height dimensions)) 0) redraw)
                (setl height-offset (minus height-offset (height dimensions)))
            )
        )
    )
